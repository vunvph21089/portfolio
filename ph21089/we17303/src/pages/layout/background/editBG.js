...
import { getBg , editBg } from "../../../api/background";
...
const editBG = ({ id }) => {
    ...
    return urls 
      ...
      <h1 class="mb-5 text-danger">Edit backgrounds</h1>
      <form action="" id="form-add">
      
      <div class="form-group">
      <label for="" class="form-label">Background name (Tên nền)</label>
      <input type="text" class="form-control" value ="${background.name}" id="bg-name" />
      </div>
